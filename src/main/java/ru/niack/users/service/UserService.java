...
public class UserService {
  ...
  public Long add(User userData) {
    User user = userData.getId() == null ? new User() : userData;
    this.userRepository.save(user);
    return 1L;
  }

  public Long update(Long id, User userData){
    userData.setId(id);
    return add(userData);
  }

  public Long delete(Long id, User userData){
    userData.setId(id);
